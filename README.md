...
> # 💡 프로젝트 소개 
🖥️ React 를 활용 (create-react-app 패키지를 통해 프로젝트 생성) 하여 To Do List 프로그램을 만들어보았습니다. <br><br>

### 🖥️ 핵심 기능

 - 일정 추가 · 수정 · 삭제

 - 전체 일정을 달력 or 리스트 형태 (페이지네이션 적용) 로 조회
